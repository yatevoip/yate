...
void YateSIPPartyHolder::transportChangedStatus(int stat, const String& reason)
{
    ...
    if (!p)
	return;
    YateSIPTransport* trans = static_cast<YateSIPTransport*>(p->getTransport());
